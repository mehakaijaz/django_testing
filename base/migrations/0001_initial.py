# Generated by Django 4.2.7 on 2024-05-05 09:59
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('project', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='expenses', to='base.project')),
            ],
            options={
                'ordering': ('-amount',),
            },
